"""Convergence and trace-recovery tests for the GMM tau-p Newton-LM inversion."""
...
from GlobalMatrix.taup_inversion import compute_taup_traces, invert_taup


class TestGMMTaupInversion:
    """Verify that the GMM Newton-LM inversion recovers a known 3-layer sub-ocean model."""
